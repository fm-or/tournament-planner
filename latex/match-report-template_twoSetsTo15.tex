...
\begin{document}
	...
	\begin{figure}[h]
	   ...
	   \begin{tikzpicture}
	       ...
	       \createPoints{below right=12mm and 0mm of origin}{T1}{5}{3}
	       \createPoints{above right=0mm and 20mm of T1-P5}{T2}{5}{3}
	        
	       \node[left=6mm of T1-P1] (points) {\Large \textbf{Score:}};
	       \node[right=6mm of T2-P5] {\phantom{\Large \textbf{Score:}}};
	
	       \coordinate[below right=15mm and 0mm of T1-P11.south west] (result);
	       \draw[-] (result) -- (result -| T1-P15.south east);
	       \draw[-] (result -| T2-P11.south west) -- (result -| T2-P15.south east);
	       \node[anchor=193] at (result -| points.193) {\Large \textbf{Score:}};
	
	       \coordinate (midTop) at ($(T1-P5.north)!0.5!(T2-P1.north)$);
	       \coordinate (midBot) at ($(T1-P15.south)!0.5!(T2-P11.south)$);
	       \draw[-] (midTop) + (0, .5) -- (result -| midBot) --  + (0, -.05);
	       
	       \coordinate[below=15mm of result] (winner);
	       \draw[-] (winner) -- (winner -| T2-P15.south east);
