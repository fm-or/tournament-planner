...
\begin{document}
	...
	\begin{center}
	   ...
	   \Large{
	       ...
	       \begin{tabular}{@{}R{0.394\textwidth}@{}C{.25em}@{}C{.075\textwidth}@{}C{.25em}@{}L{.394\textwidth}@{}}
	             && \textbf{vs.} &&  \\[-.1em]
	            \cline{1-2}\cline{4-5}
	            \small{serve in first set} & & &  & \small{serve in second set}
	       \end{tabular}
	   }\\[1.5em]
	   \large{
	...
	\begin{figure}[h]
	   ...
	   \begin{tikzpicture}
	       ...
	       \node[below left= 0mm and 6mm of origin] (set) {\Large \textbf{Set 1:}};
	       \createPoints{below right=10mm and 0mm of origin}{T1}{5}{5}
	       \createPoints{above right=0mm and 20mm of T1-P5}{T2}{5}{5}
	        
	       \node[left=6mm of T1-P1] (points) {\Large \textbf{Score:}};
	       \node[right=6mm of T2-P5] {\phantom{\Large \textbf{Score:}}};
	
	       \coordinate[below right=10mm and 0mm of T1-P21.south west] (result);
	       \draw[-] (result) -- (result -| T1-P25.south east);
	       \draw[-] (result -| T2-P21.south west) -- (result -| T2-P25.south east);
	       \node[anchor=193] at (result -| points.193) {\Large \textbf{Score:}};
	
	       \coordinate (midTop) at ($(T1-P5.north)!0.5!(T2-P1.north)$);
	       \coordinate (midBot) at ($(T1-P25.south)!0.5!(T2-P21.south)$);
	       \draw[-] (midTop) + (0, .5) -- (result -| midBot) --  + (0, -.05);
	       
	       \coordinate[below=10mm of result] (winner);
	       \draw[-] (winner) -- (winner -| T2-P25.south east);
	...
	\begin{figure}[h]
	   ...
	   \begin{tikzpicture}
	       \coordinate (origin) at (0, 0);
	       \node[below left= 0mm and 6mm of origin] (set) {\Large \textbf{Set 2:}};
	       \createPoints{below right=10mm and 0mm of origin}{T1}{5}{5}
	       \createPoints{above right=0mm and 20mm of T1-P5}{T2}{5}{5}
	        \node[left=6mm of T1-P1] (points) {\Large \textbf{Score:}};
	       \node[right=6mm of T2-P5] {\phantom{\Large \textbf{Score:}}};
	       ...
	       \node[anchor=191] at (winner -| points.191) {\Large \textbf{Winner:}};
			...
			\coordinate[below=10mm of winner] (description);
			
	       \node[anchor=west,align=left,text width=35em] at (description -| points.west) {Please bring this report directly to the tournament organizers after the end of the game!};
	   \end{tikzpicture}
	\end{figure}
\end{document}
