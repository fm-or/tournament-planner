...
\tikzset{titlenode/.style={draw, minimum width=\b, minimum height=1.2cm, align=left}}
\tikzset{itemnode/.style={titlenode, text width=\c, minimum height=1.2cm}}
\tikzset{itemnodeWide/.style={titlenode, text width=\d, minimum height=1.2cm}}
\tikzset{smallnode/.style={draw, minimum height=0.8cm, minimum width= 1.5cm, minimum height=1.2cm}}
...
\begin{document}
    ...
    \huge{\textbf{\ifthenelse{\a=1}{Procedure and Results}{Second Group Phase - Schedule}}}
    \vspace{2em}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \createGame{below=0mm of origin}{Nr}{Serving (first set)}{Receiving (first set)}{}{Referee}{Time}{Points}% this is the header
